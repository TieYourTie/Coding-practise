...
test <- read_csv("Documents/GitHub/The-data-analysis-job--/The data/house-prices-advanced-regression-techniques/test.csv")
...
#######running the lasso and ridge regression because there are way too many variance here. 
